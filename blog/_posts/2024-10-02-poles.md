...
Let $z_1$ be a point in $\gamma_1$ and $z_2$ be a point in $\gamma_2$. We connect them by a path $\gamma_3$ and another slighly parallel path $\gamma_4$ such that they're not more than a $\epsilon$ apart.
