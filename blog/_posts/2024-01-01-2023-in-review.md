...
<figure class="image_float_left">
  <img src="{{resources_path}}/thumbnail.png" alt="Prompt used to generate this: an illustration for a post card with the background of China and New Zealand during New Year's eve." />
</figure>
...
I read the book *Effective C++* by Scott Meyers and didn't find it as useful as his *Effective Modern C++*. I documented my notes in [[Book] Effective C++](https://www.kuniga.me/blog/2023/02/15/review-effective-cpp.html).
