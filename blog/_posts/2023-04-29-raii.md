...
[[Book] Designing Data Intensive Applications]({{blog}}/2022/05/03/review-designing-data-intensive-applications.html) - The book *Designing Data Intensive Applications* describes *eventual consistency* and *strong consistency*. This reminds me a lot the behavior difference between C++ destructors and Python finalizers.
