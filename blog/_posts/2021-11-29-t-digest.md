...
I had no idea about how t-digest worked and am happy with my current understanding. t-digest is an approximate data structure which accuracy for low memory footprint. The implementation is relatively simple, but the theory behind less so.
