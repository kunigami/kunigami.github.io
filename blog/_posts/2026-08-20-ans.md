...
Speaking of lossy, in many cases it's a tradeoff we can take, such as in [Linear Predictive Coding]({{blog}}/2021/05/13/lpc-in-python.html) and [T-Digest]({{blog}}/2021/11/29/t-digest.html).
