...
[Max Area Under a Histogram]({{blog}}/2021/12/11/pitch-via-cepstrum.html), [Boyer–Moore Majority Vote Algorithm]({{blog}}/2021/12/11/pitch-via-cepstrum.html), [Maximum Non-Empty Intersection of Constraints]({{blog}}/2021/12/11/pitch-via-cepstrum.html).
