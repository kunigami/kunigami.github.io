...
* [[Book] Streaming Systems]({{blog}}/2022/07/26/review-streaming-systems.html) - Chapter 9 talks about streaming joins more generally in less detail.
...
* [[Paper] Spanner]({{blog}}/2017/04/27/paper-reading-spanner-google's-globally-distributed-database.html) - discusses the `TrueTime` API which is leveraged by Photon to bound clock drift across the hosts.
