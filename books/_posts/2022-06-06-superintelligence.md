...
vanity: superintelligence
rating: 5
image: "superintelligence.png"
author: "Nick Bostrom"
...
*Superintelligence* is a book by the philosopher Nick Bostrom. I read this book in 2022 but polished and uploaded my notes in 2026. Superintelligence is abbreviated as SI.
...
If we specify a general goal without thinking about consequences: e.g. cure cancer, AI might destroy humanity. For example, it might decide that killing all humans would get rid of cancer; or it might hog all Earth's resources for computing power to achieve its goal.

On ways to protect ourselves:

* Limit the AI resources (hardware, network)
* Develop multiple AIs to compute against each other - checks and balances
* Inject human values into it - this is a really hard problem: we don’t know what we want or how to express it to a machine. One idea is to have the SI figure it out for us.

But in general a lot of obvious safety nets we can attempt are not 100% bulletproof. For example, AI can trick humans in giving it network access.
