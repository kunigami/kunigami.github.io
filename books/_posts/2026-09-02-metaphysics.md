...
*Metaphysics: A Very Short Introduction* is a book by Stephen Mumford. Each chapter aims to answer a question:
...
Before we go over each in more detail, one thing I dislike about many metaphysics discussions is that a lot of it seems to be language artifacts or subjective interpretations, or more formally *semantic* (meaning we give to things) vs. *ontological* (what exists). For example when we ask *Does this table exist?*, to me its constituting atoms are there and they're arranged in a particular way. Whether we consider it an object and call it table is semantic, and doesn't tell us anything about reality.
...
I'm much more interested in this topic, mainly whether properties exist without particulars. One argument for it is if you destroy all circular things, the idea of a circle will still exist. I personally believe the real world is Plato's heaven, inspired by [Our Mathematical Universe](https://www.kuniga.me/books/2021/01/01/our-mathematical-universe.html) and [Permutation City
](https://www.kuniga.me/books/2021/02/01/permutation-city.html). In fact, I wanted to learn more about metaphysics to develop these ideas further.

<figure class="center_children">
  <img src="{{resources_path_books}}/school-of-athens.jpg"  />
...
> Everything a realist says about causation one can translate into Humean terms about the pattern of events. It then becomes harder to even articulate the difference between Humeans and their opponents.

That is, sometimes opposing views are just framing things differently or using different words.
...
This last chapter was the most interesting to me, especially the comparison with science.

## Conclusion

This book helped me be more sure of my view: that I'm only interested in parts of metaphysics, mostly those near the border of physics: time, the smallest granularity of reality, consciousness and many-worlds.

The part I dislike about metaphysics and philosophy in general is that much of it is due to language and speculating about things beyond our mind's comprehension (see *Blind spots* in [Elbow Room](https://www.kuniga.me/books/2026/05/19/elbow-room.html)). One thing I'd like to learn more about is the "axiomatization" of metaphysics, treating it more like math. You define a set of basic rules or assumptions and derive theories from it. As the author puts it:

> It looks like we only get out of the theory as explanation what we have put into it as assumption.

But I'd like something more explicit/formal. It seems like this is called **formal ontology**, so it's something I'm looking forward to exploring.

## Book Connections

Besides the books mentioned throughout the summary, here are a few other connections:

In [The Music of the Primes]({{books}}/2025/12/28/the-music-of-the-primes.html) it quotes the Platonic view "there exists, independently of the human mind, a raw and immutable mathematical reality...", the exact debate in *What is a circle?*.

Hofstadter explore consciousness as a self-referential loop in [I'm a Strange Loop]({{books}}/2020/04/01/im-a-strange-loop.html). He also talks about identity using the thought experiment of cloning an individual, which is also used by Mumford using Star Trek as background.

In [An Immense World]({{books}}/2026/08/12/an-immense-world.html) Yong introduces the concept of unwelt and how animals perceive our world vastly differently from us. When we talk about consciousness we often need to include "intelligent" animals such as dogs, dolphins, and octopuses. The last one puts question on the link between identity and consciouness: an octopus seems to have independent "brains" on their arms so it's not a single entity.
